      ...
      {showIosInstructions && (
        ...
        >
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 max-w-sm w-full text-center shadow-2xl" onClick={(e) => e.stopPropagation()}>
                ...
                <p className="mb-4 text-gray-700 dark:text-gray-300">To install this app on your iPhone or iPad, tap the "Share" button in Safari and then select "Add to Home Screen".</p>
